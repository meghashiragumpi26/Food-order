...
const Feedback = () => {
    const initialValues = {about_service:"",comments:""}
    ...
    <div>
        ...
        <div className='container mt-3'>
            <div className='row'>
                ...
                <div className='mb-3 mt-3'>
                <input type='text' value={formValues.comments} name='comments' className='form-control' placeholder='about comments' onChange={handleChange} required/> 
                </div>
